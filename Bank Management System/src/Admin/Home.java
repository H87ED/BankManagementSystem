...
public class Home {
	...
	private void initialize() {
		...
		btnLoan.setBounds(161, 336, 306, 73);
		...
		btnCustomer.setBounds(161, 449, 306, 73);
		...
		btnAccount.setBounds(161, 560, 306, 73);
		...
		btnTransaction.setBounds(683, 336, 306, 73);
		...
		JButton btnEmpoyee = new JButton("EMPLOYEE");
		btnEmpoyee.setBorderPainted(false);
		btnEmpoyee.setBackground(new Color(0, 0, 0));
		btnEmpoyee.setForeground(new Color(255, 255, 255));
		btnEmpoyee.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new Employee(id,username);
			}
		});
		btnEmpoyee.setFont(new Font("Tahoma", Font.PLAIN, 30));
		btnEmpoyee.setBounds(683, 449, 306, 73);
		frame.getContentPane().add(btnEmpoyee);
		...
		btnBalance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Conn c= new Conn();
				try {
					ResultSet rs = c.s.executeQuery("select * from admin where aid = "+id+";");
					rs.next();
					String a=rs.getString("accid");
					rs = c.s.executeQuery("select * from account where aid = "+a+";");
					rs.next();
		...
		btnBalance.setBounds(683, 560, 306, 73);
