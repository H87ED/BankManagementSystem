...
public class Home {
	...
	private void initialize() {
		...
		btnLoan.setBounds(161, 369, 306, 73);
		...
		btnAccount.setBounds(161, 519, 306, 73);
		...
		btnTransaction.setBounds(683, 369, 306, 73);
		...
		btnBalance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Conn c1= new Conn();
				try {
					ResultSet rs = c1.s.executeQuery("select * from Customer where custid = "+id+";");
					rs.next();
		...
		btnBalance.setBounds(683, 519, 306, 73);
