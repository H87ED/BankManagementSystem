...
public class UserLogin {
	...
	private void initialize() {
		...
		Image img=(new ImageIcon(UserLogin.class.getResource("/icon/Bank_icon.png"))).getImage();
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String q="select * from customer where auname = '"+ausername+"' and password = '"+apass+"';";
				try {
					ResultSet rs=c1.s.executeQuery(q);
					
					if(rs.next()){
						aid= Integer.parseInt(rs.getString("custid"));
